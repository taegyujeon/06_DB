...
-- INSERT INTO EMPLOYEE2 VALUES(14개컬럼값 순서대로);
INSERT INTO EMPLOYEE2 VALUES(900, '장채현', '901123-2345678',
                            'jang_ch@kh.or.kr', '01012341234',
                            'D1', 'J7', 'S3', 4300000, 0.2, 200,
                            SYSDATE, NULL, 'N');
...
INSERT INTO DEPARTMENT2 VALUES('D0','개발사업부','L1');
SELECT * FROM DEPARTMENT2;
...
/* 작성한 컬럼 순서대로 VALUES에 값을 작성 해야 한다! */
...
INSERT INTO DEPARTMENT2(DEPT_ID,LOCATION_ID)
VALUES ('D0','L1');
